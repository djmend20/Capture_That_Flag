...
extension ViewController {
    ...
    // lines 24-50 allows us to select which annotation to give the flag since the screen constantly
    // updates as you move it else after you move the screen the annotations will revert back to the
    // ordinary annotations. Reason why this is not a switch format is annotations can not be compared
    // Therefore annotation comes with a property to compare values as seen by these if block statements
