...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    @IBAction func beginGame(_ sender: Any) {
        ...
        if !(startGame) {
            ...
            gameRecord = gameSession(timeAmount: amountTime, timer: timer, locationManger: locationManager, endGame: landMark, label: timeLeft, result: resultDisplay, announcment: announcment, view: view, mapView: mapkitView)
            startGame = true
            //viewDidLoad()
            }
    }
