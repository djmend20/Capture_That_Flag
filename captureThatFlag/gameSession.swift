...
class gameSession  {
    ...
    init(timeAmount: Int, timer: Timer, locationManger: CLLocationManager, endGame: Array<MKPointAnnotation>, label: UILabel, result: UILabel, announcment: UIView, view: UIView, mapView: MKMapView) {
